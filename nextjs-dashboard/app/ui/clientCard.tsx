...
export default function ClientCard( { client, option }: { client: any, option: any} ) {
	...
	return (
		<Fragment>
			<div className={ `m-1 grid grid-cols-[15%_70%_15%] gap-1 text-gray-700 ${ ( option.clickable ) ? 'hover:bg-blue-200 cursor-pointer p-0 min-h-[50px] rounded-lg bg-gray-200 shadow-lg': 'p-0 text-sm min-h-[70px] bg-gray-100 ' } ` } onClick={ (e) => { setShowModalWarpper(true) } }>
